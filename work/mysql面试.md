...
![事务的特性](https://mmbiz.qpic.cn/mmbiz_jpg/JdLkEI9sZfeqQdu9uVCstQxKgrVNhyGGXFE3yIqKgn3EiaNthER1dJRbeDrZcCw5icyILj8ibURMbBE5eicScOjMyw/640?tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)事务的特性
...
4. **垂直分区：**
   ...
   **简单来说垂直拆分是指数据表列的拆分，把一张列比较多的表拆分为多张表。** 如下图所示，这样来说大家应该就更容易理解了。
   ...
   ![img](https://mmbiz.qpic.cn/mmbiz_jpg/JdLkEI9sZfeqQdu9uVCstQxKgrVNhyGGJvOFAp3y0J23QzZc1ut11icR60KAX5hr8pRibqN8gPFWDiaNq4tl9x5uQ/640?tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)img
...
5. **水平分区：**
   ...
   **保持数据表结构不变，通过某种策略存储数据分片。这样每一片数据分散到不同的表或者库中，达到了分布式的目的。 水平拆分可以支撑非常大的数据量。**
   ...
   ![数据库水平拆分](https://mmbiz.qpic.cn/mmbiz_jpg/JdLkEI9sZfeqQdu9uVCstQxKgrVNhyGGZXqa7Ml6EJiahIUJX37mybH4bZOFErgHdp6ajzAgnBJPSKGnq13clxw/640?tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)数据库水平拆分
